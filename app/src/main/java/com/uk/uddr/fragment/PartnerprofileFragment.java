...
public class PartnerprofileFragment extends Fragment implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    TextView txt_address,  txt_desciption, txt_profile_name, txt_user_time, txt_userreview, txt_read_rev, txt_review, txt_user_name,txt_mail,txt_phone,txt_whtsapp;
    ...
    private void init() {
        ...
        write_review = view.findViewById(R.id.btn_submit_review);
...
//        img_fav_dark = view.findViewById(R.id.img_fav_dark);
        ...
        write_review.setOnClickListener(clickListener);
...
//        img_fav_dark.setOnClickListener(clickListener);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.rel_back:
                    fragment4 = new PartnerFragment();
                    bundle4 = new Bundle();
                    bundle4.putString("store_type_id", store_type_id);
                    bundle4.putString("store_id", store_id);
                    bundle4.putString("store_type", store_type);

                    fragment4.setArguments(bundle4);
                    fm4 = ((AppCompatActivity) mContext).getSupportFragmentManager();
                    fragmentTransaction4 = fm4.beginTransaction();
                    fragmentTransaction4.replace(R.id.frameLayout, fragment4);
                    fragmentTransaction4.commit(); // save the changes


                    break;

                case R.id.btn_profile_menu:
